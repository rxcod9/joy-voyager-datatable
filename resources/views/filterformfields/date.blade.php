<input type="date" class="form-control" data-filter-group-from data-filter-group="{{ $row->field }}" name="{{ $row->field }}[from]"
...
<input type="date" class="form-control" data-filter-group-to data-filter-group="{{ $row->field }}" name="{{ $row->field }}[to]"
